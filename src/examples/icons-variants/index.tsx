...
export default createWidget(
    <WContainer orientation="vertical">
        ...
        <WContainer orientation="horizontal" fixedSize={45} padding={5}>
            ...
            <WIcon icon="home" color="primary" size="medium" variant="Outlined" fixedSize={70} />
            <WIcon icon="home" color="primary" size="medium" variant="Round" fixedSize={70} />
            <WIcon icon="home" color="primary" size="medium" variant="Sharp" fixedSize={70} />
            <WSpacer />
        </WContainer>
        <WSpacer />
    </WContainer>
