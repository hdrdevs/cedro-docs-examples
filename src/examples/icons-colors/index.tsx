...
export default createWidget(
    <WContainer orientation="vertical">
        ...
        <WContainer orientation="horizontal" fixedSize={45} padding={5}>
            ...
            <WIcon icon="home" color="secondary" size="medium" variant="Filled" fixedSize={70} />
            <WIcon icon="home" color="success" size="medium" variant="Filled" fixedSize={70} />
            <WIcon icon="home" color="warning" size="medium" variant="Filled" fixedSize={70} />
            <WIcon icon="home" color="error" size="medium" variant="Filled" fixedSize={70} />
            <WSpacer />
        </WContainer>
        <WSpacer />
    </WContainer>
